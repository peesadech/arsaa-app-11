...
@php
    ...
    $subtitle = $isEdit ? 'Update role details' : 'Role Registration';
    ...
    $cardTitle = $isEdit ? 'Modify Role' : 'Role Details';
    $cardDesc = $isEdit 
        ? "You are updating role #{$role->id}. Ensure permissions are assigned correctly."
    ...
    $btnText = $isEdit ? 'Save Changes' : 'Create Role';
