...
@php
    ...
    $subtitle = $isEdit ? 'Update semester details' : 'Semester Registration';
    ...
    $cardTitle = $isEdit ? 'Modify Semester' : 'Semester Details';
    $cardDesc = $isEdit 
        ? "You are updating semester #{$semester->id}."
    ...
    $btnText = $isEdit ? 'Save Changes' : 'Create Semester';
