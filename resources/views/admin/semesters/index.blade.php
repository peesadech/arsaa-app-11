    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#semestersTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.semesters.data') }}",
                    data: function (d) {
                        d.status = $('#statusFilter').val();
                    }
                },
                columns: [
                    { data: 'semester_number', name: 'semester_number', className: 'px-6 py-4 font-bold text-gray-800 dark:text-gray-200' },
