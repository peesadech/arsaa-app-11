...
@php
    ...
    $title = $isEdit ? 'Edit Classroom' : 'Create New Classroom';
    $subtitle = $isEdit ? 'Update classroom details' : 'Classroom Registration';
    ...
    $cardTitle = $isEdit ? 'Modify Classroom' : 'Classroom Details';
    $cardDesc = $isEdit 
        ? "You are updating classroom #{$classroom->id}. Ensure all details are correct."
        : 'Define a new system classroom.';
    ...
    $btnText = $isEdit ? 'Save Changes' : 'Create Classroom';
