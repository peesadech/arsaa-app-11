            ...
            <form class="space-y-6" method="POST" action="{{ route('password.confirm') }}">
                ...
                <div class="space-y-2">
                    ...
                    <div class="group relative">
                        ...
                        <input id="password" type="password"
                               class="appearance-none block w-full pl-11 pr-4 py-4 bg-gray-50 dark:bg-[#3a3b3c] border-2 border-transparent rounded-2xl text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-0 focus:border-indigo-500 focus:bg-white dark:focus:bg-[#3a3b3c] transition-all duration-200 @error('password') border-rose-500 bg-rose-50 dark:bg-rose-900/20 @enderror"
                ...
                <div class="flex flex-col space-y-4">
                    ...
                    @if (Route::has('password.request'))
                        <a class="text-xs font-bold text-gray-400 hover:text-indigo-600 text-center uppercase tracking-widest transition-colors" href="{{ route('password.request') }}">
